 ...
 * @author Hafees
 */
public class PracticeExam extends javax.swing.JFrame {
    private ButtonGroup group1;
    private String answercorrectOrwrong="",studentanswer;
    private int count,current,currentanswer, questionNo,id,markedAnswers,displayanswer;
    ...
    private PracticeExam() {
      
    }

    PracticeExam(RegistrationDTO regdto, ExaminationDTO examdto) {
         initComponents();
        this.regdto=regdto;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Total Questions-06");
        jPanel6.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 4, 160, 40));
        ...
        lblquestion.setBackground(new java.awt.Color(204, 255, 204));
        lblquestion.setFont(new java.awt.Font("Cambria Math", 1, 18)); // NOI18N
        lblquestion.setOpaque(true);

        lblnumber.setBackground(new java.awt.Color(204, 255, 204));
        ...
        lblyouranswer_diplay.setBackground(new java.awt.Color(204, 255, 204));
        ...
        lblcorrecranswer_diplay.setBackground(new java.awt.Color(204, 255, 204));
        ...
        jLabel9.setText("Practical Exam");
        pnlheader.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 0, 330, 40));
        ...
        pnlheader.add(jButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(1390, 0, 40, 30));
        pnlheader.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 80, 40));

        jLabel11.setText("jLabel1");
        pnlheader.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 0, 70, 40));
...
//       }
        ...
        if(((attemtedQuestion.size()==6)&&(current>5))){
      ...
      status="Pass";
        ...
        try {
           ...
           JOptionPane.showMessageDialog(this, "Successfully Result saved");
            new ResultViewPractical(regdto,examdto,status,marks).setVisible(true);
        this.setVisible(false);
           }else{
            JOptionPane.showMessageDialog(this, " Result Not saved");
           }
        } catch (Exception ex) {
            Logger.getLogger(PracticeExam.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//         lblriviewanswers.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PracticeExam.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PracticeExam().setVisible(true);
            }
        });
    }
